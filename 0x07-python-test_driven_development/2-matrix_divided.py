...
def matrix_divided(matrix, div):
    """
    This function takes a matrix and a divisor as
    input and returns a new matrix where
    all elements of the given matrix are divided
    by the divisor and rounded of to 2 decimal places
    It checks if the matrix is a list of lists of
    integers or floats otherwise raises a TypeError
